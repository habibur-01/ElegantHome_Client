  ...
  return (
    <div>
      <Container>
        ...
        <div className="">
          <h1 className="text-xl font-semibold text-gray-600 border-b-[1px] mx-8 xl:mx-0 py-2 ">
            Show Products
          </h1>
          <div className="flex justify-center xl:flex-none xl:block">
            <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-14 justify-center mt-6 mb-20">
              {isTrue ? (
                <>
                  {desiredData?.map((product) => (
