  ...
  return (
    <div>
      <Container>
        <div className="flex justify-between  items-center mx-16 h-[150px] ">
          <div className=" flex justify-between items-center gap-10 ">
            ...
            <div className="flex items-center">
              ...
              />
              <button className="border-[1px] border-gray-300 h-11 px-6 rounded-r-3xl">
                <FaSearch size={20} />
              </button>
            </div>
          </div>
        ...
        <div className="">
            <h1 className="text-xl font-semibold text-gray-600 border-b-[1px] py-2 ">Show Products</h1>
